...
export const authSlice = createSlice({
    ...
    extraReducers: builder => {
        builder
            ...
            // refreshJwtAsync
            .addCase(refreshJwtAsync.fulfilled, (state, action: PayloadAction<any>) => {
                state.userId = action.payload.id;
                state.userName = action.payload.name;
                state.isAuthenticated = true;
                state.isLoading = false;
            ...
            .addCase(refreshJwtAsync.rejected, (state, action: PayloadAction<any>) => {
                state.isLoading = false;
                localStorage.removeItem(ACCESS_TOKEN);
                localStorage.removeItem(REFRESH_TOKEN);
            })
...
export const { selectUserId, selectUserName, selectIsAuthenticated, selectIsLoading, selectError } = authSlice.selectors;
